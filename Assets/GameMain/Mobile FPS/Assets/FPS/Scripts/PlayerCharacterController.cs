...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void HandleCharacterMovement()
    {
        ...
        {
#if UNITY_ANDROID
            transform.Rotate(new Vector3(0f, (LookAxis.x * RotationMultiplier), 0f), Space.Self);
#else
        ...
        {
#if UNITY_ANDROID
            // m_CameraVerticalAngle += LookAxis.y * RotationMultiplier * -1f;
